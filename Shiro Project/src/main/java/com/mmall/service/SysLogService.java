...
public class SysLogService {
    ...
    public void recover(int id){
        ...
        switch (sysLog.getType()){
            ...
            case LogType.TYPE_ROLE_ACL:
                ...
                aclRole.setOperator(RequestHolder.getCurrentUser().getUsername());
                aclRole.setOperateIp(IpUtil.getRemoteIp(RequestHolder.getCurrentRequest()));
            ...
            case LogType.TYPE_ROLE_USER:
                ...
                userRole.setOperateIp(IpUtil.getRemoteIp(RequestHolder.getCurrentRequest()));
    ...
    public PageResult<SysLogWithBLOBs> searchPageList(SearchLogParam param, PageQuery page){
        ...
        try {
            ...
            throw new ParamException("传入的日期格式有问题，正确的日期格式为：yyyy-MM-dd HH:mm:ss");
        }
    ...
    public void saveAclModuleLog(SysAclModule before, SysAclModule after){
        SysLogWithBLOBs sysLog=new SysLogWithBLOBs();
        sysLog.setType(LogType.TYPE_ACL_NODULE);
        sysLog.setTargetId(after==null?before.getId():after.getId());
        sysLog.setOldValue(before==null?"": JsonMapper.object2String(before));
        sysLog.setNewValue(after==null?"":JsonMapper.object2String(after));
        sysLog.setOperator(RequestHolder.getCurrentUser().getUsername());
